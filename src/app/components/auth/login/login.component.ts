      ...
      <div class="hidden lg:block lg:w-1/2 relative overflow-hidden">
        ...
        <div class="absolute inset-0 flex items-center justify-center z-20">
          <div class="text-center text-white p-8 bg-black/20 backdrop-blur-sm rounded-xl">
            ...
            <p class="text-lg">Access your account and continue shopping</p>
          </div>
        </div>
      </div>
      ...
      <div class="w-full lg:w-1/2 flex items-center justify-center px-4 sm:px-6 lg:px-8 py-12">
        <div class="max-w-md w-full space-y-8">
          <div class="text-center">
            <h2 class="text-3xl font-bold text-gray-900 dark:text-white">Log in to Exclusive</h2>
          ...
          <form class="mt-8 space-y-6">
            ...
            <div class="flex items-center justify-between">
              <div class="text-sm">
                <a routerLink="/forgot-password" class="font-medium text-red-500 hover:text-red-400">
                  Forgot Password?
                </a>
              </div>
            </div>
            ...
            <p class="mt-4 text-center text-sm text-gray-600 dark:text-gray-400">
              ...
              <a routerLink="/signup" class="font-medium text-red-500 hover:text-red-400"> Create Account </a>
            </p>
          </form>
        </div>
      </div>
